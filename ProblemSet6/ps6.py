...
class PhraseTrigger(Trigger):
    def __init__(self, t1):
        self.t1 = t1
    def evaluate(self, story):       
        return (self.t1 in story.getTitle()) or (self.t1 in story.getSubject()) or (self.t1 in story.getSummary())
    ...
    for s in stories:
        for t in triggerlist:
            if t.evaluate(s) == True:
                if s not in triggerStories:               
                    triggerStories.append(s)                
